 ...
 * 用户添加一个文集
 */
export let AddBooKs = function (req: Request, res: Response, next: NextFunction) {
 ...
 * 获取一个文集
 */
export let GetBooKs = function (req: Request, res: Response, next: NextFunction) {
    if(!req.params.id){
        res.json({
            "meta": {
                "code": 422,
 ...
 * 更新一个文集
 */
export let UploadBooks = function (req: Request, res: Response, next: NextFunction) {
    if((req as any).isAuthenticated()){
        res.json({
            "meta": {
                "code": 403,
 ...
 * 获取全部文集
 */
export let GetAllBooKs = function (req: Request, res: Response, next: NextFunction) {
 ...
 * 删除一个文集
 */
export let RemoveBooKs = function (req: Request, res: Response, next: NextFunction) {
    if((req as any).isAuthenticated()){
        res.json({
            "meta": {
                "code": 403,
