...
export class CorpusController{
     ...
     * 用户添加一个专题
     */
    async AddCorpus(req: Request, res: Response, next: NextFunction){
     ...
     * 获取一个专题
     */
    async GetCorpus(req: Request, res: Response, next: NextFunction){
        if(!req.params.id){
            res.json({
                "meta": {
                    "code": 422,
     ...
     * 更新一个专题
     */
    async UploadCorpus(req: Request, res: Response, next: NextFunction){
        if((req as any).isAuthenticated()){
            res.json({
                "meta": {
                    "code": 403,
     ...
     * 获取全部专题
     */
    async GetAllCorpus(req: Request, res: Response, next: NextFunction) {
