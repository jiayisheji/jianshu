 ...
 */
// tslint:disable-next-line: no-any
export function isFunction<T = any>(val: any): val is (...reset: Array<any>) => T {
 ...
 */
// tslint:disable-next-line: no-any
export function isNil<T = undefined | null>(val: any): val is T {
 ...
 */
// tslint:disable-next-line: no-any
export function isPrimitive<T = null | boolean | number | string | symbol>(val: any): val is T {
 ...
 */
// tslint:disable-next-line: no-any
export function isArrayLike<T = any>(val: any): val is ArrayLike<T> {
 ...
 */
// tslint:disable-next-line: no-any
export function isLength(val: any): val is number {
