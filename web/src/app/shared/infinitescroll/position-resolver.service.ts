...
import { ContainerRef, IPositionElements, IPositionStats, IResolver } from './interface';
...
export class PositionResolverService {
  ...
  private offsetTop (elem: ContainerRef, axis: AxisResolverService, isWindow: boolean) {
    const topKey = axis.topKey();
  ...
  private pageYOffset (elem: ContainerRef, axis: AxisResolverService, isWindow: boolean) {
